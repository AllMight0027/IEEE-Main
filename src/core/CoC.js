  ...
  return (
    <div className="container bg-white text-dark mt-4">
      ...
      <div className="row mt-5 mb-4">
        ...
        <br />
        <b>Enforcement</b>
        No member shall use organisation assets for any personal gain or publish
        any official document(s) / resource(s) without due authorization.
        <br />
        Violations of the Code of Conduct may be reported by sending an email to
        ieee@srmist.edu.in. All reports will be reviewed and investigated and
        ...
        <br /> We hold the right and responsibility to remove comments or other
        contributions that are not aligned to this Code of Conduct, or to ban
        temporarily or permanently any members for other behaviours that we deem
        inappropriate, threatening, offensive, or harmful. <br />
